      ...
      <div className="footer-content">
        ...
        <div className="footer-section brand-section">
          <div className="footer-logo">
            <span className="logo-os">edu</span>
            <span className="logo-dire">future</span>
          </div>
          <p className="footer-tagline">
            Connecting talent with opportunities. Building careers, one connection at a time.
          </p>
        ...
        <div className="footer-section">
          ...
          <ul className="footer-links">
            ...
            <li><Link to="/students">Student Desk</Link></li>
        ...
        <div className="footer-section">
          ...
          <ul className="footer-links">
            ...
            <li><Link to="/contact">Career Guidance</Link></li>
            <li><Link to="/certificate">Certificate Verification</Link></li>
            <li><Link to="/contact">Online Support</Link></li>
          </ul>
        </div>
        ...
        <div className="footer-section">
          ...
          <ul className="footer-contact">
            <li>
              ...
              <span>123 south Street, Tamil Nadu, India 600001</span>
            </li>
            <li>
              ...
              <span>info@edufuture.com</span>
            </li>
            <li>
              <span className="contact-icon">📞</span>
              <span>9965719690</span>
            </li>
            <li>
              <span className="contact-icon">⏰</span>
              <span>24/7 working</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="footer-bottom">
        <div className="footer-bottom-content">
          <p className="copyright">
            © {currentYear} edufuture. All rights reserved.
          </p>
